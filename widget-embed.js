  ...
  async function sendMessage() {
    ...
    try {
      ...
      if (data.disqualified) {
        ...
        submitCandidate('disqualified');
        isProcessing = false;
        setInputEnabled(false);
        return;
      }

      // If we've collected enough data, submit it — but keep the chat open
      if (data.conversationComplete) {
        submitCandidate('data_complete');
      }
    } catch (err) {
      hideTyping();
